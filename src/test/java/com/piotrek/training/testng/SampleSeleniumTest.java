package com.piotrek.training.testng;
...
public class SampleSeleniumTest {
	...
	public void startBrowser() {
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\Piotrek\\Desktop\\chromedriver_win32\\chromedriver.exe");
...
//		driver.findElement(By.xpath("/html/body/nav/div/a[2]")).click();
		...
		driver.findElement(By.xpath("//*[@id=\"identifierId\"]")).sendKeys("robalrop");
